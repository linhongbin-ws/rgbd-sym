...
if args.radius is not None:
    sym_args['radius_ratio_low'] = args.radius
    sym_args['radius_ratio_high'] = args.radius
if args.height is not None:
    sym_args['height_ratio_low'] = args.height
    sym_args['height_ratio_high'] = args.height
if args.screw is not None:
    sym_args['screw_angle_low'] = args.screw
    sym_args['screw_angle_high'] = args.screw
